...
bt1 = Button(tela, width=25,height=3, text="Gerar Grafico Pizza", background= "#6B7DFA", foreground="#fff", relief=GROOVE)
bt1.place(x=540, y=325)
bt2 = Button(tela, width=25,height=3, text="Gerar Gráfico em Coluna", background= "#6B7DFA", foreground="#fff", relief=GROOVE)
bt2.place(x=540, y=450)
bt3 = Button(tela, width=25,height=3, text="Gerar Gráfico em Linha", background= "#6B7DFA", foreground="#fff", relief=GROOVE)
